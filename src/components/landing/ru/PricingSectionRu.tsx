...
const pricingItems = [
  {
    ...
    price: '48 € – 79 €',
    description: 'Полная очистка от пыли и замена термопасты',
    icon: Sparkles,
    popular: true
  },
  {
    service: 'Установка ОС',
    price: '38 €',
    description: 'Чистая установка Windows/macOS включая драйверы',
    icon: Monitor
  },
  {
    service: 'Диагностика',
    price: '20 €',
    description: 'Профессиональная диагностика и определение неисправности',
    icon: HardDrive
  },
  {
    service: 'Защитное стекло',
    price: '15 €',
    description: 'Установка качественного защитного стекла на дисплей',
    icon: Shield
  },
  {
    service: 'Техническая чистка телефона',
    price: '23 €',
...
export default function PricingSectionRu() {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Честные цены без скрытых платежей. Сложные ремонты оцениваем индивидуально после диагностики.
          </p>
        </motion.div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-semibold text-slate-900 mb-1">
                  Индивидуальная оценка сложных ремонтов
                </h4>
                <p className="text-slate-600 text-sm">
                  Ремонт материнских плат, замена чипов и другие сложные работы оцениваем после бесплатной диагностики. Свяжитесь с нами для точной оценки.
                </p>
              </div>
            </div>
          </motion.div>
    ...
    return (
      ...
      >
        ...
        <p className="text-slate-600">
          Мы свяжемся с вами как можно скорее с ценовым предложением.
        </p>
      </motion.div>
    );
  }
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">
          Опишите вашу проблему, и мы отправим вам точную оценку стоимости ремонта
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          <Textarea
            placeholder="Опишите проблему с вашим устройством (напр. 'iPhone 12 не включается после падения', 'Ноутбук перегревается и выключается')"
