        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#sluzby">
                <Button variant="outline" className="w-full sm:w-auto border-2 border-slate-200 hover:border-blue-200 hover:bg-blue-50 text-slate-700 font-semibold px-8 py-6 rounded-2xl text-lg transition-all">
                  Naše služby
