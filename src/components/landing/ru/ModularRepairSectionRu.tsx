...
const repairTypes = [
  { icon: Monitor, label: 'Дисплеи' },
  { icon: Battery, label: 'Батареи' },
  { icon: Mic, label: 'Микрофоны' },
  { icon: Cable, label: 'Разъёмы' },
  { icon: Smartphone, label: 'Динамики' },
];
...
const benefits = [
  {
    icon: Clock,
    title: 'До 3 дней',
    description: 'Большинство модульных ремонтов выполняем за 3 рабочих дня',
    color: 'blue' as const,
  },
  {
    icon: BadgeCheck,
    title: 'Оригинальные запчасти',
    description: 'Используем исключительно оригинальные запчасти от производителя',
    color: 'orange' as const,
  },
  {
    icon: ShieldCheck,
    title: 'Гарантия 12 месяцев',
    description: 'На все модульные ремонты предоставляем полную гарантию',
...
export default function ModularRepairSectionRu() {
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            Стандартные замены компонентов выполняем быстро и профессионально. 
            Дисплеи, батареи, разъёмы и другие детали меняем с использованием оригинальных запчастей.
          </p>
        </motion.div>
